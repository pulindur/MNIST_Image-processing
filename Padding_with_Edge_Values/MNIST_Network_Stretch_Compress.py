...
train_img = np.load('train_img_2.npy')
train_lab = np.load('train_lab_2.npy')

test_img = np.load('test_img_2.npy')
test_lab = np.load('test_lab_2.npy')
