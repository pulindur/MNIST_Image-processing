...
train_img12 = np.zeros((60000, 28, 28), dtype='uint8')
...
test_img12 = np.zeros((10000, 28, 28), dtype='uint8')
...
np.save('train_img_1_2.npy', train_img12)
np.save('train_lab_1_2.npy', train_lab)

np.save('test_img_1_2.npy', test_img12)
np.save('test_lab_1_2.npy', test_lab)
